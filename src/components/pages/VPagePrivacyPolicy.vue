<template>
    <div style="margin: 25px 20px 85px 20px">
        <h1>Privacy Policy for coronavirus-map.com.br</h1>

        <p>At COVID-19 MAP, accessible from https://coronavirus-map.com.br, one of our main priorities is the privacy of our
            visitors. This Privacy Policy document contains types of information that is collected and recorded by
            COVID-19 MAP and how we use it.</p>
        ...
        <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
            regards to the information that they shared and/or collect in COVID-19 MAP. This policy is not applicable to
        ...
        <p>COVID-19 MAP follows a standard procedure of using log files. These files log visitors when they visit
            ...
            Privacy Policy was created with the help of the <a href="https://www.privacypolicygenerator.info">Privacy
                Policy Generator</a> and the <a href="https://www.privacypolicytemplate.net/">Privacy Policy
                Template</a>.</p>

        <h2>Cookies and Web Beacons</h2>

        <p>Like any other website, COVID-19 MAP uses 'cookies'. These cookies are used to store information including
        ...
        <p>Google is one of a third-party vendor on our site. It also uses cookies, known as DART cookies, to serve ads
            ...
            Policy at the following URL – <a href="https://policies.google.com/technologies/ads">https://policies.google.com/technologies/ads</a>
        </p>


        <h2>Advertising Partners Privacy Policies</h2>

        <P>You may consult this list to find the Privacy Policy for each of the advertising partners of COVID-19
            MAP.</p>

        <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
            used in their respective advertisements and links that appear on COVID-19 MAP, which are sent directly to
        ...
        <p>Note that COVID-19 MAP has no access to or control over these cookies that are used by third-party
            advertisers.</p>

        <h2>Third Party Privacy Policies</h2>

        <p>COVID-19 MAP's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
        ...
        <p>COVID-19 MAP does not knowingly collect any Personal Identifiable Information from children under the age of
