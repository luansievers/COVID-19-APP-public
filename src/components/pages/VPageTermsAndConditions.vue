<template>
    <div style="margin: 25px 20px 85px 20px">
        <h1>Terms and Conditions</h1>

        <p>Welcome to COVID-19 MAP!</p>

        <p>These terms and conditions outline the rules and regulations for the use of coronavirus-map.com.br's Website, located
            at https://coronavirus-map.com.br/.</p>

        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use COVID-19
            MAP if you do not agree to take all of the terms and conditions stated on this page. Our Terms and
            Conditions were created with the help of the <a href="https://www.termsandconditionsgenerator.com">Terms And
                Conditions Generator</a> and the <a
                    href="https://www.privacypolicyonline.com/terms-conditions-generator/">Free Terms & Conditions
                Generator</a>.</p>
        ...
        <p>We employ the use of cookies. By accessing COVID-19 MAP, you agreed to use cookies in agreement with the
            coronavirus-map.com.br's Privacy Policy.</p>
        ...
        <p>Unless otherwise stated, coronavirus-map.com.br and/or its licensors own the intellectual property rights for all
            material on COVID-19 MAP. All intellectual property rights are reserved. You may access this from COVID-19
            MAP for your own personal use subjected to restrictions set in these terms and conditions.</p>

        <p>You must not:</p>
        <ul>
            <li>Republish material from COVID-19 MAP</li>
            <li>Sell, rent or sub-license material from COVID-19 MAP</li>
            <li>Reproduce, duplicate or copy material from COVID-19 MAP</li>
            <li>Redistribute content from COVID-19 MAP</li>
        </ul>

        <p>This Agreement shall begin on the date hereof.</p>

        <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
            areas of the website. coronavirus-map.com.br does not filter, edit, publish or review Comments prior to their presence
            on the website. Comments do not reflect the views and opinions of coronavirus-map.com.br,its agents and/or affiliates.
            Comments reflect the views and opinions of the person who post their views and opinions. To the extent
            permitted by applicable laws, coronavirus-map.com.br shall not be liable for the Comments or for any liability,
        ...
        <p>coronavirus-map.com.br reserves the right to monitor all Comments and to remove any Comments which can be considered
        ...
        <p>You hereby grant coronavirus-map.com.br a non-exclusive license to use, reproduce, edit and authorize others to use,
        ...
        <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
            ...
            coronavirus-map.com.br; and (d) the link is in the context of general resource information.</p>
        ...
        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
            you must inform us by sending an e-mail to coronavirus-map.com.br. Please include your name, your organization name,
            contact information as well as the URL of your site, a list of any URLs from which you intend to link to our
            Website, and a list of the URLs on our site to which you would like to link. Wait 2-3 weeks for a
            response.</p>
        ...
        <p>No use of coronavirus-map.com.br's logo or other artwork will be allowed for linking absent a trademark license
            agreement.</p>
